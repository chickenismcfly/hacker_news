...
export const Card = <T extends CardBaseProps>(props: CardProps<T>) => {
  ...
  return (
    <div className="bg-white rounded-xl border border-primary-200 shadow-sm hover:shadow-md transition-shadow duration-200 flex flex-col">
      <div className="flex-[3] p-5">
        <h2 className="text-sm font-semibold leading-snug">
          <a
            ...
            className="text-primary-950 hover:text-primary-600 transition-colors duration-150"
          >
            {title}
          </a>
        </h2>
      ...
      <div className="flex-[2] px-5 pb-4 space-y-2">
        ...
        <div className="flex justify-between">
          ...
          <button
              ...
              className="text-xs text-slate-600 hover:text-primary-600 transition-colors disabled:cursor-default"
      ...
      <div className="flex-1 px-5 pb-5">
        <span className="inline-block text-xs bg-primary-100 text-primary-700 border border-primary-200 px-2 py-0.5 rounded-full font-mono">
          #{id}
        </span>
      </div>
    </div>
